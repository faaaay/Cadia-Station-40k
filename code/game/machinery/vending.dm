...
/obj/machinery/vending //I was just going to add some new items, but with the full code I couldn't resist making vendors more hackable. -Drake
	...
	var/heretical = 0 //Is the vendor slogans hacked?
	var/throwfast = 0 //Is the vendor hacked on top of the initial throwing wire to throw items more frequently?
	var/toxic = 0 //Is the vendor hacked to vend corrupted items?
	var/rigged = 0 //Is the vendor rigged?
...
/obj/machinery/vending/attack_hand(mob/user)
	...
	if(rigged)
		rigged = 0
		malfunction() //Breaks the vending machine.
		explosion(src.loc, 0, 0, 3, 5, flame_range = 4) //Small explosion.
		return
...
/obj/machinery/vending/Topic(href, href_list)
	...
	if((href_list["vend"]) && (vend_ready))
		...
		spawn(vend_delay)
			...
			var/atom/movable/I = new R.product_path(get_turf(src))
			if(toxic && I.reagents)
				I.reagents.add_reagent(pick("plasma","mutagen","sacid","space_drugs"), 10) //Toxic vending goods. Not particularly effective for a tool vendor, obviously. But pretty bad if done to, for example, the booze-o-mat.
			vend_ready = 1
			return
...
/obj/machinery/vending/proc/speak(message)
	...
	if(heretical)
		message = pick("The emperor is dead.","Praise papa nurgle!","BLOOD FOR THE BLOOD GOD, SKULL FOR THE SKULL THRONE!","Death to the corpse emperor!","Let the galaxy burn!","Praises to slaanesh!","Praises to Tzeench!","Nurgle loves us...","The inquisition is a corrupt and dogmatic system of societal control that mimics totalitarian governmental institutions in the past and probably ought to be removed for the benefit of human society.","I'm a heretic. Ain't that a burning shame...","I GONNA KRUMP YA GITZ","GIMME YER ZOGGIN HATZ","MARSHALL LAW HAS BEEN DECLARED ERMAGURD!!!","MY TOES ARE ABSOLUTELY LIVID!!!","TEH EMPRAH SUX!!1!11!!1!11","The mechanicus is moronic.","Fuck the inquisitors.","To hell with the Imperium!","Oh no! The imperial guards are retarded!","I'M A FUCKIN' HERETEK!","Slaanesh is better than the emperor!","You know, the dark eldar would really make great leaders of mankind.","Ultramarines suck!","Kill all the sallymanders in the whole world!","Beakies are all nerds!","Space coke erry day...")
...
/obj/machinery/vending/proc/throw_item()
	...
	for(var/datum/data/vending_product/R in product_records)
		...
		if(toxic && throw_item.reagents)
			throw_item.reagents.add_reagent(pick("plasma","mutagen","sacid","space_drugs"), 10)
		break
	if(!throw_item)
		return 0
...
/obj/machinery/vending/boozeomat
	...
	products = list(/obj/item/weapon/reagent_containers/food/drinks/bottle/amasec = 10, /obj/item/weapon/reagent_containers/food/drinks/bottle/gin = 5,/obj/item/weapon/reagent_containers/food/drinks/bottle/whiskey = 5,
	...
	contraband = list(/obj/item/weapon/reagent_containers/food/drinks/tea = 10, /obj/item/weapon/reagent_containers/food/drinks/contraband = 10, /obj/item/weapon/reagent_containers/food/drinks/soda_cans/heresy = 3, /obj/item/weapon/reagent_containers/food/drinks/flask/heresy = 1) //Heretical drink hidden in the Imperial booze vendor
	vend_delay = 15
	product_slogans = "When the numbness of a heretical planet gets too much to bare, let me numb your insides so you can continue working.;Imperial fuel, for the imperial soul.;One hundred percent Imperial brew.;Strong enough for an Emperor, made for an Imperial."
...
/obj/machinery/vending/coffee
	...
	contraband = list(/obj/item/weapon/reagent_containers/food/drinks/ice = 10, /obj/item/weapon/reagent_containers/food/drinks/contraband = 10)
...
/obj/machinery/vending/snack
	...
	product_slogans = "Try our new Cron Cake!;Twice the calories for half the price!"
	...
	contraband = list(/obj/item/weapon/reagent_containers/food/snacks/ccake = 6, /obj/item/weapon/reagent_containers/food/snacks/chips/eucalyptus = 2)
...
/obj/machinery/vending/cola
	...
	product_slogans = "Quench the build up of IMPERIAL FURY with an ice cold cola!"
	...
	contraband = list(/obj/item/weapon/reagent_containers/food/drinks/soda_cans/thirteenloko = 5, /obj/item/weapon/reagent_containers/food/drinks/soda_cans/rootbeer = 10, /obj/item/weapon/reagent_containers/food/drinks/soda_cans/energydrink = 2)
...
/obj/machinery/vending/cigarette //Lho leaf is in. //I *might* have upped the amount of cocaine in these. This will be interesting.
	name = "cigarette machine" //OCD had to be uppercase to look nice with the new formating
	desc = "If you want to get cancer, might as well do it in style"
	product_slogans = "Guarenteed to have the side effects healed by the Adeptus Medicus.;Blow smoke into the face of heresy!;This could be your last day, have a cigarette!;Lho leaf erry day...;Get all your Imperium-sanctioned drugs here!"
	product_ads = "Probably not bad for you!;Don't believe the scientists!;It's good for you!;Don't quit, buy more!;Smoke!;Nicotine heaven.;Best cigarettes since 2150.;Award-winning cigs."
	vend_delay = 34
	icon_state = "cigs"
	products = list(/obj/item/clothing/mask/cigarette/lho = 10, /obj/item/weapon/storage/fancy/cigarettes = 10,/obj/item/weapon/storage/box/matches = 10,/obj/item/weapon/lighter/random = 4,/obj/item/weapon/rollingpaperpack = 5)
	contraband = list(/obj/item/weapon/lighter/zippo = 4, /obj/item/weapon/reagent_containers/glass/bottle/stimulant = 20, /obj/item/weapon/reagent_containers/glass/bottle/nanites = 1) //Some strong and very illegal substances
...
/obj/machinery/vending/medical //Some morphine bottles and an epi-injector as contraband
	...
	contraband = list(/obj/item/weapon/reagent_containers/pill/tox = 3,/obj/item/weapon/reagent_containers/pill/stox = 4,/obj/item/weapon/reagent_containers/pill/antitox = 6, /obj/item/weapon/reagent_containers/syringe/epinephrine = 2, /obj/item/weapon/reagent_containers/glass/bottle/morphine = 6)
...
/obj/machinery/vending/hydronutrients
	...
	product_slogans = "Forty thousand years of botany research can't be wrong!;Use hydronutrients. Anything else is heretical!"
...
/obj/machinery/vending/hydroseeds
	...
	product_slogans = "I'm Commander Shepard and these are my favorite seeds on the citadel.;Seeds directly from Terra!;All seeds approved by the office of the Inquisition!!"
	product_ads = "We like plants!;Grow some crops!;Grow, baby, growww!;Aw h'yeah son!"
	icon_state = "seeds"
	products = list(/obj/item/seeds/ambrosiavulgarisseed = 6,/obj/item/seeds/appleseed = 6,/obj/item/seeds/bananaseed = 6,/obj/item/seeds/berryseed = 6,
						/obj/item/seeds/cabbageseed = 6,/obj/item/seeds/carrotseed = 6,/obj/item/seeds/cherryseed = 6,/obj/item/seeds/chantermycelium = 6,
						/obj/item/seeds/chiliseed = 6,/obj/item/seeds/cocoapodseed = 6,/obj/item/seeds/coffee_arabica_seed = 6,/obj/item/seeds/cornseed = 6,
						/obj/item/seeds/eggplantseed = 6,/obj/item/seeds/grapeseed = 6,/obj/item/seeds/grassseed = 6,/obj/item/seeds/lemonseed = 6,
						/obj/item/seeds/limeseed = 6,/obj/item/seeds/orangeseed = 6,/obj/item/seeds/potatoseed = 6,/obj/item/seeds/poppyseed = 6,
						/obj/item/seeds/pumpkinseed = 6,/obj/item/seeds/replicapod = 6,/obj/item/seeds/soyaseed = 6,/obj/item/seeds/sunflowerseed = 6,
						/obj/item/seeds/tea_aspera_seed = 6,/obj/item/seeds/tobacco_seed = 6,/obj/item/seeds/tomatoseed = 6,
						/obj/item/seeds/towermycelium = 6,/obj/item/seeds/watermelonseed = 6,/obj/item/seeds/wheatseed = 6,/obj/item/seeds/whitebeetseed = 6)
	contraband = list(/obj/item/seeds/amanitamycelium = 3,/obj/item/seeds/glowshroom = 3,/obj/item/seeds/libertymycelium = 3,/obj/item/seeds/nettleseed = 3,
						/obj/item/seeds/plumpmycelium = 3,/obj/item/seeds/reishimycelium = 3)
	premium = list(/obj/item/weapon/reagent_containers/spray/waterflower = 2)
...
/obj/machinery/vending/magivend
	...
	icon_state = "MagiVend"
	product_slogans = "For the Craftworld!"
	vend_delay = 15
...
/obj/machinery/vending/autodrobe
	...
	products = list(/obj/item/clothing/mask/fawkes = 1, /obj/item/clothing/suit/chickensuit = 1,/obj/item/clothing/head/chicken = 1,/obj/item/clothing/under/gladiator = 1,
					...
					/obj/item/clothing/head/rabbitears = 1, /obj/item/clothing/under/maid = 1, /obj/item/clothing/head/maidbow = 1,
...
/obj/machinery/vending/autodrobe/celeb/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W, /obj/item/weapon/coin/harlequin))
		user.visible_message("[user] puts the [W] in the [src].")
		qdel(W)
		new /obj/item/clothing/suit/armor/harlequin(get_turf(src))
		return
	..()
...
/obj/machinery/vending/dinnerware
	...
	contraband = list(/obj/item/weapon/kitchen/rollingpin = 2, /obj/item/weapon/butch = 2, /obj/item/weapon/reagent_containers/food/snacks/ration = 20)
...
//This one's from Hannahsaurus
/obj/machinery/vending/security
	name = "Imperial Equipment vendor"
	desc = "It's a supplier of guns for the Imperial Guard"
	product_ads = "Don't go into combat unarmed!;Best armoury there is!;Get them before they get you!"
	icon_state = "sec"
	icon_deny = "sec-deny"
	req_access_txt = "1"
	products = list(/obj/item/weapon/reagent_containers/food/snacks/donut/normal = 10,

					/obj/item/ammo_box/magazine/lasgunmag = 10,// Make sure to change these if wrong ~Hannah

					/obj/item/weapon/gun/projectile/automatic/lasgun = 5,
					/obj/item/weapon/complexknife/combatknife = 10,
					/obj/item/weapon/handcuffs = 10,
					)
	contraband = list(/obj/item/weapon/storage/fancy/donut_box = 5,
					/obj/item/weapon/flamethrower = 1,
					/obj/item/weapon/gun/projectile/automatic/silenced = 5,
					/obj/item/weapon/grenade/flashbang = 6,
