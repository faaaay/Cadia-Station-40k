...
/var/const/access_cent_inquisitor = 110 //Inquisitorial Authority, maybe going to make the inquisitor lair only open to inquisitors unless physically broken into.
/var/const/access_cent_hereticus = 111
