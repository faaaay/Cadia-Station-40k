...
/area
	...
	var/uid
	var/list/ambientsounds = list('sound/ambience/ambiatm1.ogg')
...
/area/Entered(A)
	...
	if(!L.client.ambience_playing)
		...
		L << sound('sound/ambience/ambiatm1.ogg', repeat = 1, wait = 0, volume = 35, channel = 2)
...
/proc/has_gravity(var/atom/AT)
	...
	if(locate(/obj/effect/fake_floor) in T) //Always gravity on a moving ship!
		return 1
