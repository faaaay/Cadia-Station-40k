...
/obj/structure/alien/weeds/temperature_expose(datum/gas_mixture2/air, exposed_temperature, exposed_volume)
...
/obj/structure/alien/egg/temperature_expose(datum/gas_mixture2/air, exposed_temperature, exposed_volume)
