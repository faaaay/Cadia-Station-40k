...
/obj/structure/mineral_door/transparent/plasma/temperature_expose(datum/gas_mixture2/air, exposed_temperature, exposed_volume)
...
/obj/structure/mineral_door/ork
	mineralType = "orkdoor"
	hardness = 3
	close_delay = 100
	openSound = 'sound/effects/doorcreaky.ogg'
...
/obj/structure/mineral_door/ork/CheckHardness()
	playsound(loc, 'sound/effects/bodyfall3.ogg', 100, 1)
	..()

//obj/structure/mineral_door/ork/BlockSuperconductivity()
//	if(opacity)
//		return 1