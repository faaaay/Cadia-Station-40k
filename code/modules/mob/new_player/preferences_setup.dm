	...
	proc/update_preview_icon()		//seriously. This is horrendous.
		...
		if(job_civilian_low & ASSISTANT)//This gives the preview icon clothes depending on which job(if any) is set to 'high'
			...
			switch(job_engsec_high)
				...
				if(IMPPSYKER)
					clothes_s = new /icon('icons/mob/uniform.dmi', "imperial_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "imperialboots"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/head.dmi', "chaplain_hood"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/suit.dmi', "imperium_monk"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/back.dmi', "impbag"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "imperialbelt"), ICON_OVERLAY)
				if(CHIEF)
