...
/mob/living/carbon/human/smurfs/leader/New()
	..()
...
/mob/living/carbon/human/smurfs/leader/CanPass(atom/A, mob/target)
...
/mob/living/carbon/human/smurfs/leader/Life()
	..()
	if(iscarbon(src))
...
/mob/living/carbon/human/smurfs/CanPass(atom/A, mob/target)
	if(istype(A) && A.pass_flags == PASSULTRA)
		return 1
	if(istype(src) && src.density == 0)
		return prob(99)
...
/mob/living/carbon/human/smurfs/New()
	..()
	var/obj/item/device/radio/headset/R = new /obj/item/device/radio/headset/headset_cent
	R.set_frequency(1441)
	equip_to_slot_or_del(R, slot_ears)
	...
	spawn(20)
		...
		switch(weaponchoice)
			if("Apothecary")
				...
				equip_to_slot_or_del(new /obj/item/clothing/suit/armor/smurfapoth, slot_wear_suit)
			...
			if("Tactical")
				equip_to_slot_or_del(new /obj/item/clothing/under/color/black, slot_w_uniform)
				equip_to_slot_or_del(new /obj/item/clothing/suit/armor/smurfparmor, slot_wear_suit)
				equip_to_slot_or_del(new /obj/item/clothing/shoes/magboots/um, slot_shoes)
				equip_to_slot_or_del(new /obj/item/clothing/gloves/um, slot_gloves)
				equip_to_slot_or_del(new /obj/item/clothing/glasses/night, slot_glasses)
				...
				regenerate_icons()
				rename_self("[name]")
/mob/living/carbon/human/smurfs/Life()
	..()
	if(iscarbon(src))
		var/mob/living/carbon/C = src
		C.handcuffed = initial(C.handcuffed)
