...
/*
This is for the ERT Ultramarines, they have different helmets to distinguish them from WL smurfs
*/

/mob/living/carbon/human/whitelisted/umm
	name = "Unknown"
	real_name = "Unknown"
	universal_speak = 1
	gender = "male"
...
/mob/living/carbon/human/whitelisted/umm/CanPass(atom/A, mob/target)
	if(istype(A) && A.pass_flags == PASSULTRA)
		return 1
	if(istype(src) && src.density == 0)
		return prob(99)
...
/mob/living/carbon/human/whitelisted/umm/New()
	..()
	var/obj/item/device/radio/headset/R = new /obj/item/device/radio/headset/headset_cent
	R.set_frequency(1441)
	equip_to_slot_or_del(R, slot_ears)
...
/mob/living/carbon/human/whitelisted/umm/Life()
	..()
	if(iscarbon(src))
		var/mob/living/carbon/C = src
		C.handcuffed = initial(C.handcuffed)
