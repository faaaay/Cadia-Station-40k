/mob/living/carbon/human/whitelisted/smurfs/leader
...
/mob/living/carbon/human/whitelisted/smurfs/leader/New()
	..()
...
/mob/living/carbon/human/whitelisted/smurfs/leader/CanPass(atom/A, mob/target)
...
/mob/living/carbon/human/whitelisted/smurfs/leader/Life()
	..()
	if(iscarbon(src))
...
/mob/living/carbon/human/whitelisted/smurfs
	name = "Unknown"
	real_name = "Unknown"
	icon = 'icons/mob/32x40/astartes.dmi'
	name = "astartes"
...
/mob/living/carbon/human/whitelisted/smurfs/CanPass(atom/A, mob/target)
	if(istype(A) && A.pass_flags == PASSULTRA)
		return 1
	if(istype(src) && src.density == 0)
		return prob(99)
...
/mob/living/carbon/human/whitelisted/smurfs/New()
	..()
	var/obj/item/device/radio/headset/R = new /obj/item/device/radio/headset/headset_cent
	R.set_frequency(1441)
	equip_to_slot_or_del(R, slot_ears)
...
/mob/living/carbon/human/whitelisted/smurfs/Life()
	..()
	if(iscarbon(src))
		var/mob/living/carbon/C = src
		C.handcuffed = initial(C.handcuffed)
