//Psykers energy reserve code here
...
/mob/living/carbon/human/psychic/proc/imprison(var/mob/living/carbon/T in oview(7))
...
/mob/living/carbon/human/psychic/proc/smite(var/atom/T)
	set name = "Smite (60)"
...
/mob/living/carbon/human/psychic/proc/telepath(mob/M as mob in orange(30,src)) //Like whisper but free, and much farther range.
	set name = "Telepathy"
