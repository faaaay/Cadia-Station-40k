...
/obj/item/weapon/reagent_containers/glass/bottle/blood
	name = "synth-blood bottle"
	desc = "A small bottle of synth-blood."
	icon = 'icons/obj/chemical.dmi'
	icon_state = "bottle3"
	New()
		..()
...
/obj/item/weapon/reagent_containers/glass/bottle/Zombie
	...
	New()
		..()
		var/datum/disease/F = new /datum/disease/transformation/zombie(50)
		var/list/data = list("viruses"= list(F))
		reagents.add_reagent("blood", 20, data)
...
/obj/item/weapon/reagent_containers/glass/bottle/psytropene
	name = "Psytropene Bottle"
	desc = "A small bottle. Contains psytropene used for psychological conditioning."
	icon = 'icons/obj/chemical.dmi'
	icon_state = "bottle23"
	New()
		..()
