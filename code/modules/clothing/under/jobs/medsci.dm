...
/obj/item/clothing/under/rank/scientist
	desc = "It's made of a special fiber that provides minor protection against biohazards. It has markings that denote the wearer as a researcher."
...
/obj/item/clothing/under/rank/chief_medical_officer
	desc = "It's a jumpsuit worn by a Sister Hospitalier. It provides minor biological protection."
	name = "sister hospitalier's jumpsuit"
	icon_state = "maid"
	item_state = "maid"
	item_color = "maid"
	permeability_coefficient = 0.50
