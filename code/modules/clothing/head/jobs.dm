...
/obj/item/clothing/head/caphat
	...
	icon_state = "captain"
	desc = "Made from the hide of purged heretics."
	item_state = "that"
...
/obj/item/clothing/head/chaplain_hood
	...
	desc = "It's hood that covers the head. It keeps you warm during the space winters and shows your devotion to the Emperor."
...
/obj/item/clothing/head/beret/sec
	name = "Arbites beret"
	desc = "A beret with the logo of the Adeptus Arbites. For officers that are more inclined towards style than safety."
	icon_state = "beret_badge"


/obj/item/clothing/head/beret/sec/navyhos
	name = "head arbiter's beret"
	desc = "A beret with the insignia of the Adeptus Arbites. A symbol of excellence, a badge of courage, a mark of distinction."
	icon_state = "hosberet"


/obj/item/clothing/head/beret/sec/navywarden
	name = "jailor's beret"
	desc = "A beret with the Adeptus Arbites insignia emblazoned on it. Not to be mixed with casual attire."
